...
public class InformacoesUsuarioTest {
    ...
    @Test
    public void removerUmContatoDeUmUsuario(@Param(name="telefone")String telefone, @Param(name="mensagem")String mensagemEsperada) {
        ...
        String screenshotArquivo = "C:\\Users\\Marcelo Tavares\\test-report\\taskit" + Generator.dataHoraParaArquivo() + test.getMethodName() + ".png";
